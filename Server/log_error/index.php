        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="#"  id='bnt-acessar' data-toggle="modal" data-target="#login-modal">Acessar &nbsp;<i class="glyphicon glyphicon-lock"></i></a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
                ...
                <div id="div-forms">
                    ...
                    <form id="lost-form" style="display:none;" action="../recuperar/esqueceu_senha.php" method="post" autocomplete="off" style="display:none;">
                        <div class="modal-body">
                            ...
                            <input type="email"  name="emailRecupera" autocomplete="off" class="form-control" placeholder="E-mail" required/>
                    ...
                    <form id="register-form" action="../cadastro_user/post_cadastro_user.php" method="post" autocomplete="off" style="display:none;">
                        <div class="modal-body">
                            ...
                            <input class="form-control" type="text" placeholder="Matrícula sem '/'" name='matricula' required>
                            <input style="margin-top: 10px;" class="form-control" type="email" placeholder="E-Mail *" name="email" required>   
                            <input class="form-control" type="text" placeholder="RG *" name="rg" required>
                            <input  class="form-control" type="text" placeholder="Data de nascimento: Ex:. DD/MM/AAAA *" name="datanascimento" id="date" required>     
