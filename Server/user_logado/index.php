                        ...
                        <div class="modal-body">
                            ...
                            <map name="sgmap">
                                <area alt="Auditório SG-11" onclick="fecharmodal()" 
                                 coords="493,324,571,368" shape="rect">   
                            </map>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <map name="mymap">
                                <area shape="rect" coords="654,453,696,409" onclick="fecharmodal()">
                                <area shape="rect" coords="609,475,645,427" onclick="fecharmodal()">
                                <area shape="rect" coords="548,447,600,484" onclick="fecharmodal()">
                                <area shape="rect" coords="500,469,553,498" onclick="fecharmodal()">
                                <area shape="rect" coords="432,488,502,540" onclick="fecharmodal()">
                                <area shape="rect" coords="222,431,285,463" onclick="fecharmodal()">
                            </map>
                            </div>
                            <p>Clique em alguma sala para ver o seu itinerário.</p>
                            <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> Fechar</button>
