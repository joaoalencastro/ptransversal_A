        ...
        <div class="portfolio">
            ...
            <div class="row" id="space">
                ...
                <div class="col-lg-4" id="the-basics">
                  <form id="formulario">
                        <input class="typeahead" type="text" placeholder="Ex.: Algoritmo e Estrutura de Dados" id="barra-pesquisa" style="width: 300px; padding: 5px; border: 1px solid #ccc; margin-top: 10px;">
